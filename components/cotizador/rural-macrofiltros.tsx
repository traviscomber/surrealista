...
import { MacrofilterSection } from "./macrofilter-section"
import type { MacrofilterOption } from "./macrofilter-section"
import { Beef, Building2, Droplets, Home, Leaf, MapPin, TreePine, Trees, Wheat, Zap } from "lucide-react"

export type RuralMacrofilters = {
...
const MACROFILTROS_OPTIONS = {
  aptitudAgricola: [
    ...
    { id: "profundidad", label: "Profundidad Adecuada", description: "Profundidad superior a 80 cm" },
  ...
  recursosHidricos: [
    ...
    { id: "vertientes", label: "Vertientes", description: "Vertientes u ojos de agua" },
    { id: "esteros", label: "Esteros", description: "Cursos de agua naturales" },
    { id: "lagos-lagunas", label: "Lagos o Lagunas", description: "Cuerpos de agua estática" },
  ...
  aptitudFruticola: [
    ...
    { id: "historial-productivo", label: "Historial Productivo", description: "Antecedentes de producción" },
  ...
  aptitudGanadera: [
    ...
    { id: "manga", label: "Manga", description: "Infraestructura de trabajo" },
  ...
  aptitudLechera: [
    ...
    { id: "agua-abundante-lechera", label: "Agua Abundante", description: "Disponibilidad para operación lechera" },
    ...
    { id: "acceso-veterinario", label: "Acceso Veterinario", description: "Proximidad a servicios veterinarios" },
  ] as MacrofilterOption[],
  potencialForestal: [
  ...
  desarrolloInmobiliario: [
    ...
    { id: "regulacion-vigente", label: "Regulación Vigente", description: "Normativa aplicable" },
  ...
  conservacionTurismo: [
    ...
    { id: "rios-lagos-turismo", label: "Ríos o Lagos", description: "Presencia de ríos o lagos" },
    { id: "vistas-panoramicas", label: "Vistas Panorámicas", description: "Vistas de valor territorial" },
    { id: "senderos", label: "Senderos", description: "Senderos o caminos para trekking" },
    { id: "potencial-carbono", label: "Potencial de Carbono", description: "Capacidad estimada de captura" },
  ] as MacrofilterOption[],
  infraestructura: [
    ...
    { id: "corrales-infraestructura", label: "Corrales o Estructuras", description: "Infraestructura pecuaria" },
  ] as MacrofilterOption[],
  accesibilidad: [
    ...
    { id: "conectividad", label: "Conectividad", description: "Señal celular o internet disponible" },
    { id: "distancia-aeropuerto", label: "Distancia a Aeropuerto", description: "Proximidad a aeropuertos" },
    { id: "puerto-acceso", label: "Acceso Marítimo", description: "Proximidad a puertos" },
  ] as MacrofilterOption[],
}

const sections: Array<{
  key: keyof RuralMacrofilters
  title: string
  description: string
  icon: React.ReactNode
  defaultOpen?: boolean
}> = [
  { key: "aptitudAgricola", title: "1. Aptitud Agrícola", description: "Capacidad y características del suelo para cultivos", icon: <Wheat className="h-5 w-5 text-primary" />, defaultOpen: true },
  { key: "recursosHidricos", title: "2. Recursos Hídricos", description: "Disponibilidad y derechos de agua", icon: <Droplets className="h-5 w-5 text-primary" /> },
  { key: "aptitudFruticola", title: "3. Aptitud Frutícola", description: "Potencial para producción de frutas", icon: <Leaf className="h-5 w-5 text-primary" /> },
  { key: "aptitudGanadera", title: "4. Aptitud Ganadera", description: "Capacidad para ganadería extensiva", icon: <Beef className="h-5 w-5 text-primary" /> },
  { key: "aptitudLechera", title: "5. Aptitud Lechera", description: "Potencial para producción lechera", icon: <Home className="h-5 w-5 text-primary" /> },
  { key: "potencialForestal", title: "6. Potencial Forestal", description: "Capacidad para producción forestal", icon: <TreePine className="h-5 w-5 text-primary" /> },
  { key: "desarrolloInmobiliario", title: "7. Desarrollo Inmobiliario", description: "Potencial para subdivisión y desarrollo", icon: <Building2 className="h-5 w-5 text-primary" /> },
  { key: "conservacionTurismo", title: "8. Conservación y Turismo", description: "Potencial de conservación ecológica y turismo", icon: <Trees className="h-5 w-5 text-primary" /> },
  { key: "infraestructura", title: "9. Infraestructura", description: "Presencia de infraestructura en la propiedad", icon: <Zap className="h-5 w-5 text-primary" /> },
  { key: "accesibilidad", title: "10. Accesibilidad y Ubicación", description: "Conectividad y proximidad a servicios", icon: <MapPin className="h-5 w-5 text-primary" /> },
]
    ...
    <div className="space-y-4">
      {sections.map((section) => (
        <MacrofilterSection
          ...
          icon={section.icon}
          options={MACROFILTROS_OPTIONS[section.key]}
          selectedIds={values[section.key]}
          onChange={(selected) => handleChange(section.key, selected)}
