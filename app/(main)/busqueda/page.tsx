...
export default function UnifiedSearchPage() {
  ...
  const [driveConnectionDialogOpen, setDriveConnectionDialogOpen] = useState(false)
  ...
  const testDriveConnection = async () => {
    ...
    try {
      ...
      if (!connected) {
        setDriveConnectionDialogOpen(true)
      } else {
        console.log("[v0] Google Drive connected successfully")
      }
    } catch (error) {
      console.error("[v0] Error testing Drive connection:", error)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 p-6">
      <Dialog open={driveConnectionDialogOpen} onOpenChange={setDriveConnectionDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              <Folder className="h-5 w-5" />
              Conexión a Google Drive Requerida
            </DialogTitle>
            <DialogDescription>
              Para cargar los mapas y archivos KMZ, necesitas conectarte a Google Drive primero.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg">
              ...
              <Badge
                variant={driveConnected === true ? "default" : driveConnected === false ? "destructive" : "secondary"}
              >
                {driveConnected === true ? "Activo" : driveConnected === false ? "Error" : "Pendiente"}
              </Badge>
            </div>
            ...
            <div className="bg-gray-50 p-3 rounded-lg space-y-2">
              <div className="text-sm">
                ...
                <code className="ml-2 bg-white px-2 py-1 rounded text-xs">AIzaSyB6...XyjHTU</code>
              </div>
            </div>
            ...
            {driveConnected === false && (
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  No se pudo conectar a Google Drive. Verifica tu conexión a internet y los permisos de la API.
                </AlertDescription>
              </Alert>
            )}
            ...
            <div className="flex gap-2">
              <Button onClick={testDriveConnection} disabled={testingConnection} className="flex-1">
                {testingConnection ? (
                  <>
              ...
              {driveConnected && (
                <Button onClick={() => setDriveConnectionDialogOpen(false)} variant="default" className="flex-1">
                  Continuar
                </Button>
              )}
            </div>
      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center gap-2">
              {driveConnected === true ? (
                ...
                <Badge
                  ...
                  onClick={() => setDriveConnectionDialogOpen(true)}
                >
        ...
        {driveConnected === null || testingConnection ? (
          <Card className="p-12">
            <div className="flex flex-col items-center justify-center gap-4">
              <Loader2 className="h-12 w-12 animate-spin text-blue-500" />
              <p className="text-lg font-medium">Conectando a Google Drive...</p>
              <p className="text-sm text-gray-500">Verificando acceso a archivos KMZ</p>
            </div>
          </Card>
        ) : !driveConnected ? (
          <Card className="p-12">
            <div className="flex flex-col items-center justify-center gap-4">
              ...
              <p className="text-lg font-medium">No se pudo conectar a Google Drive</p>
              <p className="text-sm text-gray-500">Haz clic en el badge de arriba para reintentar</p>
              <Button onClick={() => setDriveConnectionDialogOpen(true)}>Configurar Conexión</Button>
            </div>
          </Card>
        ) : (
          <>
