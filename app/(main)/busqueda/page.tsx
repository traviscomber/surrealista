    ...
    <div className="min-h-screen bg-background px-4 py-4">
      <div className="w-full">
        ...
        <div className="mb-6 border-b pb-4">
          <h1 className="mb-2 text-3xl font-bold text-foreground">Panel operativo</h1>
          <p className="text-base text-muted-foreground max-w-2xl">
            Selecciona un módulo para trabajar con campos, clientes, comunicaciones, tareas, archivos y análisis.
          </p>
        </div>

        <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
        <TabsList className="grid w-full grid-cols-2 gap-1 rounded-2xl border border-border bg-muted/50 p-1 md:grid-cols-7">
          <TabsTrigger
            value="campos"
            className="flex flex-col items-center gap-2 rounded-xl px-2 py-3 text-muted-foreground transition-colors data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm"
          >
            <Folder className="h-5 w-5" />
            <span className="text-xs font-semibold">Campos</span>
          </TabsTrigger>
          <TabsTrigger
            value="clientes"
            className="flex flex-col items-center gap-2 rounded-xl px-2 py-3 text-muted-foreground transition-colors data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm"
          ...
          >
            ...
            <span className="text-xs font-semibold">Comunicaciones</span>
          </TabsTrigger>
          <TabsTrigger
            value="tareas"
            className="flex flex-col items-center gap-2 rounded-xl px-2 py-3 text-muted-foreground transition-colors data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm"
                  ...
                  <div className="h-full group cursor-pointer">
                    <div className="relative bg-card rounded-2xl border p-8 hover:border-primary transition-all hover:shadow-xl hover:-translate-y-1 h-full">
                      ...
                      <div className="relative z-10">
                        ...
                        <h3 className="mb-2 text-2xl font-bold text-foreground">Colección KMZ</h3>
                        <p className="text-muted-foreground mb-6">
                          Gestiona y visualiza la colección de {camposData.length} archivos KMZ. Carga, indexa y administra las ubicaciones de todos tus archivos.
                        </p>
