export type ProspectingLocationRegion = {
  value: string
  label: string
  officialName: string
  communes: string[]
...
export const PROSPECTING_CHILE_LOCATIONS: ProspectingLocationRegion[] = [
  ...
  },
  {
    value: "Valparaíso",
    label: "Valparaíso",
    officialName: "Región de Valparaíso",
  ...
  },
  {
    value: "O'Higgins",
    label: "O'Higgins",
    officialName: "Región del Libertador General Bernardo O'Higgins",
  ...
  },
  {
    value: "Aysén",
    label: "Aysén",
    officialName: "Región de Aysén del General Carlos Ibáñez del Campo",
    communes: ["Coyhaique", "Lago Verde", "Aysén", "Cisnes", "Guaitecas", "Cochrane", "O'Higgins", "Tortel", "Chile Chico", "Río Ibáñez"],
  },
  {
    value: "Magallanes",
    label: "Magallanes",
    officialName: "Región de Magallanes y de la Antártica Chilena",
  ...
  },
  {
    value: "Metropolitana",
    label: "Metropolitana",
    officialName: "Región Metropolitana de Santiago",
